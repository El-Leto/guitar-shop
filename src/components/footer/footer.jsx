...
function Footer() {
  return (
    <footer className={styles.wrapper}>
      <div className={cn('container', styles.navigation)}>
        <div className={styles.links}>
          <h3 className="visually-hidden">Официальный сайт интернет-магазина Guitar Shop</h3>
        ...
        <div className={styles.menu}>
          <div className={styles.about_us}>
            ...
            <p className={styles.text}>Магазин гитар, музыкальных инструментов и гитарная мастерская в Санкт-Петербурге.</p>
            <p className={styles.text}>Все инструменты проверены, отстроены и доведены до идеала!</p>
          </div>
        ...
        <div className={styles.contacts}>
          ...
          <p className={styles.contact_text}>г. Санкт-Петербург,<br/> м. Невский проспект, ул. Казанская 6.<br/><span className={styles.phone}></span><a className={styles.phone_link} href="tel:88125005050">8-812-500-50-50</a></p>
          <p className={styles.contact_text}>Режим работы:<br/><span className={styles.clock}></span>с 11:00 до 20:00,<br/>без выходных.</p>
        </div>
      </div>
    </footer>
  );
